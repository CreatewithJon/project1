    ...
    <div className="min-h-screen bg-[#0B0F1A] font-sans text-[#F9FAFB]">
      ...
      <section className="relative pt-20 pb-16 px-6 text-center overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto">
          ...
          <p className="text-xl text-[#A1A1AA] leading-relaxed max-w-2xl mx-auto mb-10">
            I build simple AI-powered content systems that help you stay consistent, grow your audience, and generate inbound leads — without spending hours creating content every week.
          </p>
          <Link
            href="#get-started"
      ...
      <section className="py-20 px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-[#A1A1AA] leading-relaxed max-w-2xl mx-auto">
            I build you a simple AI content system that turns one idea into a week&apos;s worth of content — captions, scripts, hooks, and posts — in a fraction of the time.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-col gap-4">
            {[
              { step: "01", title: "Tell me about your business", desc: "I start with a quick intake form to understand your audience, offer, and content goals." },
              { step: "02", title: "I build your content system", desc: "I set up your brand voice, content calendar, idea bank, and repurposing workflow — personally." },
